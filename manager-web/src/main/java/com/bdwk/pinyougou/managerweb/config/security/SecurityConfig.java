package com.bdwk.pinyougou.managerweb.config.security;

import com.bdwk.pinyougou.managerweb.config.security.handler.AuthenticationSuccessHandler;
...
public class SecurityConfig<configureGlobalSecurity> extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .loginProcessingUrl("/manager/authentication")
